...
int	sys_thr_sched_set(struct thread *, struct thr_sched_set_args *);
int	sys_thr_sched_get(struct thread *, struct thr_sched_get_args *);
...
#define	SYS_AUE_sched_setparam	AUE_SCHED_SETPARAM
#define	SYS_AUE_sched_getparam	AUE_SCHED_GETPARAM
#define	SYS_AUE_sched_setscheduler	AUE_SCHED_SETSCHEDULER
#define	SYS_AUE_sched_getscheduler	AUE_SCHED_GETSCHEDULER
#define	SYS_AUE_sched_yield	AUE_NULL
#define	SYS_AUE_sched_get_priority_max	AUE_SCHED_GET_PRIORITY_MAX
#define	SYS_AUE_sched_get_priority_min	AUE_SCHED_GET_PRIORITY_MIN
#define	SYS_AUE_sched_rr_get_interval	AUE_SCHED_RR_GET_INTERVAL
...
#define	SYS_AUE_thr_sched_set	AUE_SCHED_SETSCHEDULER
#define	SYS_AUE_thr_sched_get	AUE_SCHED_GETSCHEDULER
