...
static int
jail_create(void *obj, void *data __unused)
{
...
static const osd_method_t osd_methods[PR_MAXMETHOD] = {
	[PR_METHOD_CREATE] = jail_create,
	[PR_METHOD_GET] = jail_get,
	[PR_METHOD_CHECK] = jail_check,
	[PR_METHOD_SET] = jail_set,
};
